<div class="row">
	<div class="col-md-12">
		<div class="page-header">
			<h1><?php echo __('Crear Producto'); ?></h1>
		</div>
	...
	<div class="col-xs-12">
		...
		<?php 
			...
			$this->Html->addCrumb(__('Crear Producto'));
					...
					<div class="col-md-6">
						<?php 
							...
							echo $this->BsForm->input('name', array(
								...
								'label' => __('Nombre')));
							echo $this->Form->submit(__('Crear Producto'), array(
...
<?php echo $this->Html->script('/js/products/add'); ?>
<?php $this->end();