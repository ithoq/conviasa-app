...
<div class="row">
	<div class="col-md-12">
		<div class="page-header">
			<h1><?php echo __('Editar Tripulante'); ?></h1>
		</div>
	...
	<div class="col-xs-12">
		...
		<?php 
			...
			$this->Html->addCrumb(__('Editar Tripulante'));
					...
					<div class="col-md-6">
						<?php 
							...
							echo $this->BsForm->checkbox('visa', array(
								'label' => __('¿Tiene Visa?')));
							echo $this->Form->submit(__('Editar Tripulante'), array(
...
<?php echo $this->Html->script('/js/crews/edit'); ?>
<?php $this->end();