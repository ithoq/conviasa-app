...
<div class="row">
	<div class="col-md-12">
		<div class="page-header">
			<h1><?php echo __('Registrar Entrenamiento'); ?></h1>
		</div>
	...
	<div class="col-xs-12">
		...
		<?php 
			...
			$this->Html->addCrumb(__('Registrar Emtrenamiento'));
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<?php echo __('Registrar Entrenamiento') ?>
			</div>
					...
					<div class="col-md-6">
						<?php 
							...
							echo $this->BsForm->input('place', array(
								...
								'label' => __('Lugar')));
							echo $this->Form->submit(__('Registrar Entrenamiento'), array(
...
<?php echo $this->Html->script('/js/trains/add'); ?>
<?php $this->end();